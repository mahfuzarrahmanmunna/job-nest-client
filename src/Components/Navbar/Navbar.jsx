        ...
        <div className="navbar sticky top-0 z-50 px-4 md:px-12 bg-gray-200 dark:bg-gray-900">
            <div className="navbar-start">
                <div className="dropdown">
                    <label tabIndex={0} className="btn btn-ghost p-0 lg:hidden bg-base-300 dark:bg-gray-900 dark:text-base-100">
                ...
                <figure>
                    <Link to="/" className=" items-center  hidden md:flex">
                        <img src="https://i.ibb.co/gbLmgf6Y/job-nest-freelance-web-site-logo-job-web-app.png" className="w-24 rounded bg-base-100 dark:bg-gray-900 " alt="Logo" />
                    </Link>
                </figure>
